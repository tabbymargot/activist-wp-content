...
function generate_page_header_enqueue() {
	...
	if ( ! empty( $options[ 'vertical_center' ] ) && '' !== $options[ 'content' ] ) {
...
function generate_page_header_css() {
	...
	if ( '' !== $options[ 'custom_menu_colors' ] ) {
		...
		$css->set_selector( '.generate-merged-header #site-navigation:not(.toggled) .main-nav > ul > li[class*="current-menu-"] > a, .generate-merged-header #site-navigation:not(.toggled) .main-nav > ul > li[class*="current-menu-"] > a:hover' );
...
function generate_page_header_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		...
		array(
			'type' => 'select',
			'label' => __( 'Page Header Location','page-header' ),
			'section' => $section,
			'choices' => array(
	...
	$wp_customize->add_control(
		...
		array(
			'type' => 'select',
			'label' => __( 'Single Post Header Location','page-header' ),
			'section' => $section,
			'choices' => array(
				'above-content' => __( 'Above Content Area','page-header' ),
				'inside-content' => __( 'Inside Content Area','page-header' ),
...
function generate_page_header_template_tags( $content ) {
	...
	if ( is_singular() ) {
		...
		$author = sprintf( '<span class="author vcard" itemtype="http://schema.org/Person" itemscope="itemscope" itemprop="author"><a class="url fn n" href="%1$s" title="%2$s" rel="author" itemprop="url"><span class="author-name" itemprop="name">%3$s</span></a></span>',
			...
			esc_attr( sprintf( __( 'View all posts by %s', 'page-header' ), get_the_author_meta( 'nickname', $author_id ) ) ),
