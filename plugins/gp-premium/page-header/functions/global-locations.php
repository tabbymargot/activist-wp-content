...
class Generate_Page_Header_Locations {
	...
	public function add_plugin_page() {
		add_submenu_page(
			...
			__( 'Global Locations','page-header' ),
			__( 'Global Locations','page-header' ),
			'manage_options',
	...
	public function create_admin_page() {
		...
		?>
		<div class="wrap">
			<h1><?php _e( 'Global Locations', 'page-header' ); ?></h1>
	...
	public function page_init() {
		...
		add_settings_field(
			...
			__( 'Posts page (blog)', 'page-header' ),
		...
		add_settings_section(
			...
			__( 'Post Types - Single', 'page-header' ),
			'',
			'page-header-global-locations'
		);
		...
		if ( count( $post_types ) > 0 ) {
			add_settings_section(
				...
				__( 'Post Types - Archives', 'page-header' ),
				'',
				'page-header-global-locations'
			);
		}
		...
		if ( count( $taxonomies ) > 0 ) {
			add_settings_section(
				...
				__( 'Taxonomies - Archives', 'page-header' ),
				'',
				'page-header-global-locations'
			);
		}
