...
function generate_menu_plus_reset_settings()
{
	...
	<form method="post">
		...
		<p>
			...
			submit_button( __( 'Delete Menu Plus Settings', 'menu-plus' ), 'menu-plus-button', 'menu-plus-submit', false, array( 'onclick' => esc_js( $warning ) ) ); 
			?>
		</p>
	</form>
	<?php
	...
	function generate_menu_plus_add_export()
	{
		...
		<form method="post">
			...
			<p>
				...
				<?php submit_button( __( 'Export Menu Plus Settings', 'menu-plus' ), 'button', 'submit', false ); ?>
			</p>
		</form>
		<?php
	}
