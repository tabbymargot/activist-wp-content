	...
	foreach ($post_types as $type) {
		if ( 'attachment' !== $type ) {
			add_meta_box(  
				...
				__('Disable Elements','disable-elements'), 
    ...
    <p>
		<div class="generate_disable_elements">
			<?php if ( function_exists( 'generate_top_bar' ) ) : ?>
				<label for="meta-generate-disable-top-bar" style="display:block;margin-bottom:3px;" title="<?php _e('Top Bar','disable-elements');?>">
					...
					<?php _e('Top Bar','disable-elements');?>
				</label>
			<?php endif; ?>
			...
			<label for="meta-generate-disable-post-image" style="display:block;margin-bottom:3px;" title="<?php _e('Featured Image / Page Header','disable-elements');?>">
				...
				<?php _e('Featured Image / Page Header','disable-elements');?>
			</label>
