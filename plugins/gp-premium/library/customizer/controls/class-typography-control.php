...
class GeneratePress_Pro_Typography_Customize_Control extends WP_Customize_Control
{
	...
	public function to_json() {
		...
		$this->json[ 'default_fonts_title'] = __( 'System fonts', 'generate-typography' );
		...
		$this->json[ 'family_title' ] = esc_html__( 'Font family','generate-typography' );
		$this->json[ 'weight_title' ] = esc_html__( 'Font weight','generate-typography' );
		$this->json[ 'transform_title' ] = esc_html__( 'Text transform','generate-typography' );
		$this->json[ 'category_title' ] = '';
		$this->json[ 'variant_title' ] = esc_html__( 'Variants', 'generate-typography' );
	...
	public function get_font_weight_choices() {
		return array(
			'normal' => esc_html__( 'normal', 'generate-typography' ),
			'bold' => esc_html__( 'bold', 'generate-typography' ),
			'100' => esc_html( '100' ),
			'200' => esc_html( '200' ),
			'300' => esc_html( '300' ),
			'400' => esc_html( '400' ),
	...
	public function get_font_transform_choices() {
		return array(
			'none' => esc_html__( 'none', 'generate-typography' ),
			'capitalize' => esc_html__( 'capitalize', 'generate-typography' ),
			'uppercase' => esc_html__( 'uppercase', 'generate-typography' ),
			'lowercase' => esc_html__( 'lowercase', 'generate-typography' ),
		);
	}
}
endif;
